...
myApp.config(['$routeProvider', function($routeProvider) {
  $routeProvider.
  when('/movies', {
    templateUrl : base_url+'admin_partials/movies',
    controller  : 'movies'
  }).
  when('/series', {
    templateUrl : base_url+'admin_partials/series',
    controller  : 'series'
  }).
  when('/payments', {
    templateUrl : base_url+'admin_partials/payments',
    controller  : 'payments'
  }).
  when('/admins', {
    templateUrl : base_url+'admin_partials/admins',
    controller  : 'admins'
  }).
  when('/customers', {
    templateUrl : base_url+'admin_partials/customers',
    controller  : 'customers'
  }).
  when('/ads', {
    templateUrl : base_url+'admin_partials/ads',
    controller  : 'ads'
  }).
  otherwise({
    redirectTo: 'movies'
